...
public class Constants {
    ...
    public static final String CACHE_CUSTOMER = "get-customer";
    public static final String CACHE_DELIVERY_POINTS = "get-delivery-points";
    public static final String CACHE_DELIVERY_POINT = "get-delivery-point";
    public static final String CACHE_ORDERS = "get-orders";
    public static final String CACHE_ORDER = "get-order";
